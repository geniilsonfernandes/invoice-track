...
export const Logo = ({ className }: { className?: string }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_505_35)">
      <path d="M686 0H0V686H686V0Z" fill="#0073CB" />
      <path d="M460 257H388.018L388 184L460 257Z" fill="#FFEEE9" />
      <path
        d="M186 496.5V183H482.571V368.79L334.286 294.54V463.5L284.857 496.5L235.429 463.5L186 496.5Z"
        fill="#E9FCFF"
      />
      <path
        d="M367.238 513L532 430.5L367.238 348V414L433.143 430.5L367.238 447V513Z"
        fill="#8AEC74"
      />
    </g>
    <defs>
